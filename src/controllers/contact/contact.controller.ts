...
import { ContactCreateDto } from "../../common/dto/contact/contact-create.dto";
...
export class ContactController {
    constructor(@Inject(serviceTokens.contact) private readonly contactService: ContactService) {}
